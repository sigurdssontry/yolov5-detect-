...
#python train.py --img 640 --batch 4 --epochs 30 --data shezheng.yaml --weights yolov5x.pt
...
def train(hyp, opt, device, tb_writer=None):
    ...
    with torch_distributed_zero_first(rank):
        check_dataset(data_dict)  # checkpython train.py --img 640 --batch 16 --epochs 5 --data coco128.yaml --weights yolov5s.pt
